            ...
            while(r!=0){
                ...
                XSSFRow sheetRow = sheet.createRow(i + 1);
                    if (row != null) {
                        ...
                        sheetRow.createCell(1).setCellValue(""+row.getType());
                        sheetRow.createCell(2).setCellValue(""+row.getMarque());
                        sheetRow.createCell(3).setCellValue(""+row.getModel());
                        sheetRow.createCell(4).setCellValue(""+row.getMarque());
                        sheetRow.createCell(5).setCellValue(""+row.getIntitule());
                        sheetRow.createCell(6).setCellValue(""+row.getMateriels());
                        i++;
                        r--;
